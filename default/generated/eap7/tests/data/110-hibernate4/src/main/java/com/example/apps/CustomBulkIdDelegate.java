...
public class CustomBulkIdDelegate extends TemporaryTableBulkIdStrategy {
    ...
    public MyTestIdentifier createMyTestIdentifier() {
        return new MyTestIdentifier();
    }
    ...
    private Class getIdentifierGeneratorClass(String strategy) {
        return null;
    }


    public class MyTestIdentifier implements Configurable, IdentifierGenerator {

        private MyTestIdentifier() {
        }
