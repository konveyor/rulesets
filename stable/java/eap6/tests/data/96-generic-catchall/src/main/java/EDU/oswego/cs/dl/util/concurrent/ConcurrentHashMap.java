...
public class ConcurrentHashMap 
  ...
  */
  ...
  public Object remove(Object key) {
    return removeRetObject(key, null);
  }
  ...
  protected Object removeRetObject(Object key, Object value) {
    /*
      Find the entry, then 
  ...
  private class EntrySet extends AbstractSet {
    ...
    public boolean remove(Object o) {
      ...
      return ConcurrentHashMap.this.removeRetObject(e.getKey(), e.getValue()) != null;
    }
    public int size() {
      return ConcurrentHashMap.this.size();
    }
